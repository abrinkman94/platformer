...
import com.brinkman.platformer.spine.attachments.VertexAttachment;
...
public class Slot {
     ...
     * <p>
     * See {@link VertexAttachment#computeWorldVertices(Slot, int, int, float[], int)} and {@link Animation.DeformTimeline}. */
